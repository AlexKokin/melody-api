...
extern int pthread_attr_getstack(const pthread_attr_t *__restrict,
...
extern int pthread_attr_getscope(const pthread_attr_t *__restrict,
	int *__restrict);
...
extern int pthread_attr_getschedpolicy(const pthread_attr_t *__restrict,
	int *__restrict);
extern int pthread_attr_setschedparam(pthread_attr_t *__restrict,
		const struct sched_param *__restrict);
extern int pthread_attr_getschedparam(const pthread_attr_t *__restrict,
		struct sched_param *__restrict);
extern int pthread_create(pthread_t *__restrict,
...
extern int pthread_getschedparam(pthread_t, int *__restrict,
		struct sched_param *__restrict);
...
extern int pthread_mutexattr_getrobust(
	const pthread_mutexattr_t *__restrict, int *__restrict);
extern int pthread_mutex_init(pthread_mutex_t *__restrict,
...
extern int pthread_mutex_reltimedlock_np(pthread_mutex_t *__restrict,
	const struct timespec *__restrict);
extern int pthread_mutex_unlock(pthread_mutex_t *);
extern int pthread_mutex_trylock(pthread_mutex_t *);
extern int pthread_mutex_setprioceiling(pthread_mutex_t *__restrict,
	int, int *__restrict);
extern int pthread_mutex_getprioceiling(const pthread_mutex_t *__restrict,
	int *__restrict);
extern int pthread_condattr_init(pthread_condattr_t *);
extern int pthread_condattr_destroy(pthread_condattr_t *);
extern int pthread_condattr_setclock(pthread_condattr_t *, clockid_t);
extern int pthread_condattr_getclock(const pthread_condattr_t *__restrict,
	clockid_t *__restrict);
extern int pthread_condattr_setpshared(pthread_condattr_t *, int);
extern int pthread_condattr_getpshared(const pthread_condattr_t *__restrict,
	int *__restrict);
extern int pthread_cond_init(pthread_cond_t *__restrict,
	const pthread_condattr_t *__restrict);
extern int pthread_cond_destroy(pthread_cond_t *);
extern int pthread_cond_broadcast(pthread_cond_t *);
extern int pthread_cond_signal(pthread_cond_t *);
extern int pthread_cond_wait(pthread_cond_t *__restrict,
	pthread_mutex_t *__restrict);
extern int pthread_cond_timedwait(pthread_cond_t *__restrict,
	pthread_mutex_t *__restrict, const struct timespec *__restrict);
extern int pthread_cond_reltimedwait_np(pthread_cond_t *__restrict,
	pthread_mutex_t *__restrict, const struct timespec *__restrict);
...
extern int pthread_mutexattr_gettype(const pthread_mutexattr_t *__restrict,
	int *__restrict);
extern int pthread_rwlock_init(pthread_rwlock_t *__restrict,
	const pthread_rwlockattr_t *__restrict);
extern int pthread_rwlock_destroy(pthread_rwlock_t *);
extern int pthread_rwlock_rdlock(pthread_rwlock_t *);
extern int pthread_rwlock_timedrdlock(pthread_rwlock_t *__restrict,
	const struct timespec *__restrict);
extern int pthread_rwlock_reltimedrdlock_np(pthread_rwlock_t *__restrict,
	const struct timespec *__restrict);
extern int pthread_rwlock_tryrdlock(pthread_rwlock_t *);
extern int pthread_rwlock_wrlock(pthread_rwlock_t *);
extern int pthread_rwlock_timedwrlock(pthread_rwlock_t *__restrict,
	const struct timespec *__restrict);
extern int pthread_rwlock_reltimedwrlock_np(pthread_rwlock_t *__restrict,
	const struct timespec *__restrict);
...
extern int pthread_barrier_init(pthread_barrier_t *__restrict,
	const pthread_barrierattr_t *__restrict, uint_t);
