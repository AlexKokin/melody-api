...
extern int getmsg(int, struct strbuf *__restrict,
		struct strbuf *__restrict, int *__restrct);
extern int putmsg(int, const struct strbuf *, const struct strbuf *, int);

extern int getpmsg(int, struct strbuf *__restrict,
		struct strbuf *__restrict, int *__restrict,
		int *__restrict);
