...
extern int readdir_r(DIR *__restrict, struct dirent *__restrict,
		struct dirent **__restrict);
#else	/* __PRAGMA_REDEFINE_EXTNAME */

extern int __posix_readdir_r(DIR *__restrict,
...
static int
readdir_r(DIR *__restrict __dp, struct dirent *__restrict __ent,
...
extern int readdir_r(DIR *__restrict, struct dirent *__restrict,
	struct dirent **__restrict);
	    ...
	    !defined(__PRAGMA_REDEFINE_EXTNAME))
/* transitional large file interface */
extern int readdir64_r(DIR *__restrict, struct dirent64 *__restrict,
